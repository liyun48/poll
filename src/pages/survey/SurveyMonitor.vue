<template>
	<div class="surveyMonitor">
		...
		<div v-loading='loading'>
	      ...
	      <el-table-column prop="clazzVM.grade.name" label="年级" width="100" align='center'></el-table-column>
	      <el-table-column prop="clazzVM.name" label="班级" width="100" align='center'></el-table-column>
	      <el-table-column prop="course.name" label="课程" width="100" align='center'></el-table-column>
	      <el-table-column prop="user.name" label="讲师" width="80" align='center'></el-table-column>
	      <el-table-column prop="qnVM.name" label="问卷" align='center'></el-table-column>
	      <el-table-column prop="surveydate" label="创建时间" width="160" align='center'></el-table-column>
